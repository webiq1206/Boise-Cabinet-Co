...
export async function generateMetadata({
  ...
  // Falls back to the hub hero image until the card has been generated.
  const ogFile = path.join(process.cwd(), 'public', 'images', 'og', `${params.hubSlug}.jpg`);
  const shareImageUrl = fs.existsSync(ogFile)
    ? getAbsoluteImageUrl(`/images/og/${params.hubSlug}.jpg`, getBaseUrl())
    : imageUrl;
  ...
  return {
    ...
    openGraph: {
      ...
      type: 'website',
      images: [{ url: shareImageUrl, width: 1200, height: 630, alt: `${hub.title} articles` }],
...
export default function BlogCategoryHubPage({
  ...
  if (posts.length === 0) {
    redirect(hub.hubSlug === 'treasure-valley-locations' ? '/locations' : '/blog');
  }
        ...
        <div className="container px-4 max-w-6xl mx-auto">
          ...
          {hub.pillarSlug && (
            <Link
              ...
              className="tap-target inline-flex items-center text-accent hover:underline text-sm mb-10"
            >
