        ...
        <section className="relative py-16 md:py-24 bg-gradient-to-b from-primary/10 to-background">
          <div className="container px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center space-y-4">
              <h1 className="text-4xl md:text-5xl font-bold text-foreground">Christmas Light Installation in Kuna &amp; Boise, Idaho</h1>
            ...
            <div className="container px-4">
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12 space-y-4">
                  <h2 className="text-3xl md:text-4xl font-bold tracking-tight" data-testid="text-christmas-lights-reviews-heading">
                    What Our Customers Say
                  </h2>
                  <p className="text-lg text-muted-foreground">
                    Real reviews from christmas lights customers in the Treasure Valley
                  </p>
                </div>
                <Testimonials serviceType="christmas-lights" limit={16} />
              </div>
            </div>
          </section>
