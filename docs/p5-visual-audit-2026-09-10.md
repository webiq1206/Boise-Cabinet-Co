# Boise Cabinet Co: P5 family visual audit, September 10, 2026

Site: https://boisecabinet.co. Recorded routes for this repository: 139.
...
- Widened finish-reference cards on small screens and made shared catalog-card actions wrap within their borders. Browser checks now assert action containment and 44-pixel tap height on article, room, and accessory cards.
...
The consolidated production route sweep and targeted reruns passed **1251 of 1251 route/viewport checks** (139 recorded routes at nine widths), with no recorded horizontal overflow, broken visible images, page exceptions, or console errors. All 13 route batches completed their internal-link checks without failures. [Full route workflow](https://github.com/webiq1206/Boise-Cabinet-Co/actions/runs/34520565752) tested `42c6a585a6541ed8d12613697952f055a662daed`.

The subsequent final component build passed **297 of 297 checks**, including responsive menus, sticky actions and form clearance, comparison input and sizing, and balanced cards. [Final component workflow](https://github.com/webiq1206/Boise-Cabinet-Co/actions/runs/34522973322) tested `1c17d37937b83f6eda972cb8bfcec4d86a79710e`. Additional results: browser-results: 7 passing scenarios; catalog-results: 9 passing scenarios; launcher-results: 9 passing scenarios; mobile-navigation: 15 passing scenarios; product-search-results: 9 passing scenarios.
...
The final product revision is `8fab9108592ae16e864a76158609c62d7ba11713`. Its only product change after the component build suppresses an article-card excerpt when it duplicates the title. The supplemental category-page workflow rebuilt this revision and checked the affected cards at all nine widths; phone screenshots were manually reviewed.

One supplemental localhost run recorded a third-party Clarity analytics CORS failure. The later targeted run fulfills Clarity script requests inside the browser harness so the preview sends no Clarity telemetry. Application exception, console, image, and overflow assertions remain enabled. This isolation changes verification only, not production analytics.

Supplemental route workflows: [run 34522534543](https://github.com/webiq1206/Boise-Cabinet-Co/actions/runs/34522534543) at `59af7319b59b431dd6d72ec0b556c25265d1f5f1`, [run 34522682436](https://github.com/webiq1206/Boise-Cabinet-Co/actions/runs/34522682436) at `ce9fbeea22e12ac96aaf7b3be53e235c7c0d173e`, [run 34523870567](https://github.com/webiq1206/Boise-Cabinet-Co/actions/runs/34523870567) at `a807f59071e4982bcd20adcd8ded90268580d305`, [run 34524608499](https://github.com/webiq1206/Boise-Cabinet-Co/actions/runs/34524608499) at `a6174fa6f51f5a3d5901e0b786a73154b827440f`. Each row in the CSV identifies its actual tested source and run.

6 earlier failed checks are retained in the interaction JSON. The final route table uses the later passing rerun for each affected route and viewport.
