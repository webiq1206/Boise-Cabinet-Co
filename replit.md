...
## Recent Changes
- **2025-11-25**: Fixed email logo display - copied logo assets to public/email/ folder for email templates. Fixed critical lead distribution bug - quotes now automatically create corresponding Lead records for admin dashboard. Configured Tailwind container to auto-center content with responsive padding. Lead pricing set at 10% of final quote (minimum $10). Fixed layout centering issue across all pages.
