# Email Deliverability Setup Guide for Boise Cabinet Co
...
Your emails are going to spam because **SPF, DKIM, and DMARC are not properly configured** on your `boisecabinet.co` domain. This setup is **mandatory** for inbox delivery in 2025.
...
Log into your domain registrar or DNS provider (GoDaddy, Namecheap, Cloudflare, etc.) for `boisecabinet.co`.
...
2. Select your domain `boisecabinet.co`
...
Value: resend._domainkey.boisecabinet.co.at.resend.com
TTL: 3600

Type: CNAME
Name: resend2._domainkey
Value: resend2._domainkey.boisecabinet.co.at.resend.com
TTL: 3600

Type: CNAME
Name: resend3._domainkey
Value: resend3._domainkey.boisecabinet.co.at.resend.com
TTL: 3600
```
...
Type: TXT
Name: _dmarc
Value: v=DMARC1; p=none; rua=mailto:dmarc@boisecabinet.co; ruf=mailto:dmarc@boisecabinet.co; fo=1; adkim=s; aspf=s
TTL: 3600
```
...
Type: TXT
Name: _dmarc
Value: v=DMARC1; p=quarantine; rua=mailto:dmarc@boisecabinet.co; ruf=mailto:dmarc@boisecabinet.co; fo=1; adkim=s; aspf=s; pct=25
TTL: 3600
```
...
Type: TXT
Name: _dmarc
Value: v=DMARC1; p=reject; rua=mailto:dmarc@boisecabinet.co; ruf=mailto:dmarc@boisecabinet.co; fo=1; adkim=s; aspf=s; pct=100
TTL: 3600
```
...
4. **From / reply-to / admin notifications** use `hello@boisecabinet.co` (`PLATFORM_EMAIL` in `emailLayout.ts`)
