...
export class MemStorage implements IStorage {
  ...
  async createLead(insertLead: InsertLead): Promise<Lead> {
    ...
    const lead: Lead = {
      ...
      street: insertLead.street ?? null,
      serviceArea: insertLead.serviceArea ?? null,
      state: insertLead.state ?? null,
      zip: insertLead.zip ?? null,
      county: insertLead.county ?? null,
      fullAddress: insertLead.fullAddress ?? null,
      propertyType: insertLead.propertyType ?? null,
      serviceType: insertLead.serviceType ?? null,
      businessCategory: insertLead.businessCategory ?? null,
      leadGroup: insertLead.leadGroup ?? null,
      categoriesMatched: insertLead.categoriesMatched ?? null,
      rating: insertLead.rating ?? null,
      reviewCount: insertLead.reviewCount ?? null,
      googleMapsUrl: insertLead.googleMapsUrl ?? null,
      latitude: insertLead.latitude ?? null,
      longitude: insertLead.longitude ?? null,
      distanceMi: insertLead.distanceMi ?? null,
      lastContactedAt: insertLead.lastContactedAt ?? null,
      source: insertLead.source ?? null,
      sourceDetail: insertLead.sourceDetail ?? null,
      leadType: insertLead.leadType ?? "homeowner",
      emailable: insertLead.emailable ?? false,
      emailStatus: insertLead.emailStatus ?? "new",
      pipelineStage: insertLead.pipelineStage ?? "new",
      unsubscribeToken: insertLead.unsubscribeToken ?? randomUUID(),
