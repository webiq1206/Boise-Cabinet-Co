  ...
  return (
    <>
      <section className="relative min-h-screen flex items-center overflow-hidden bg-inverse">
        ...
        />
        <div
          className="absolute inset-0 pointer-events-none bg-gradient-to-br from-inverse/65 via-inverse/45 to-inverse/20"
        />
        <div
          className="absolute inset-x-0 top-0 h-32 pointer-events-none bg-gradient-to-b from-inverse/55 to-transparent"
        />
        <div
        ...
        <div className="relative z-10 container px-4 md:px-8 py-28 md:py-36">
          <div className="grid md:grid-cols-[1.4fr_1fr] gap-10 md:gap-16 items-center">
            <Reveal>
              ...
              <p className="text-base md:text-lg leading-relaxed mb-10 max-w-xl text-inverse-muted/90">
              ...
              {[
                ...
                <Reveal key={stat.num} delay={i * 90}>
                  <div className="px-6 py-5 rounded-sm bg-inverse-foreground/7 border border-inverse-foreground/12">
                    <div className="font-sans font-light text-inverse-foreground text-3xl leading-none">
                      {stat.num}
                    </div>
