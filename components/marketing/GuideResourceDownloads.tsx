  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground mb-4">
        Print these worksheets or save the PDFs for your cabinet planning folder.
      </p>
    ...
    <div className="flex gap-3 items-start rounded-md border border-border/80 p-3 bg-muted/20">
      ...
      {isExternalPdf ? (
        <a
          href={resource.href}
          download
          className="tap-target inline-flex items-center gap-1.5 text-sm text-accent hover:underline shrink-0 font-medium"
