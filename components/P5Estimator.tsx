...
export function P5Estimator({defaultService='',headingAs='h1',projectSource}:{defaultService?:string;headingAs?:'h1'|'h2';projectSource?:ProjectSource}){
  ...
  async function analyze(){
    ...
    setBusy('Reading your documents and project details...');const form=new FormData();form.set('text',d.text);form.set('replaceScope',d.analyzedText!==undefined&&d.text!==d.analyzedText?'true':'false');form.set('resumable','true');form.set('background','true');form.set('retry','true');
    let data:any;
    do{
    checkAnalysis();
