    ...
    <div className="flex flex-col pb-20 md:pb-0">
      <Section spacing="sm" className="pt-8 md:pt-12">
        <div className="container px-4">
          ...
          <h1 className="font-serif font-light text-display md:text-[2.75rem] tracking-tight text-foreground max-w-4xl mt-6 mb-6">
            {h1}
          </h1>
      ...
      {inclusions && inclusions.length > 0 && (
        <Section divider>
          <div className="container px-4 max-w-5xl">
            <h2 className="font-serif font-light text-section-title mb-8 text-foreground">
              What&apos;s included
            </h2>
            <MarketingCard>
      ...
      {timeline && (
        <Section divider spacing="sm">
          <div className="container px-4 max-w-3xl">
            <h2 className="font-serif font-light text-xl text-foreground mb-3">Typical timeline</h2>
      ...
      {localNote && (
        <Section divider spacing="sm">
          <div className="container px-4 max-w-3xl">
            <h2 className="font-serif font-light text-xl text-foreground mb-3">Local notes</h2>
      ...
      <Section variant="inverse" spacing="sm">
        <div className="container px-4 text-center max-w-2xl mx-auto">
          <h2 className="font-serif font-light text-2xl text-inverse-foreground mb-4">
