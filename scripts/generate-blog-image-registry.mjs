...
const ENTRIES = {
  ...
  "framed-vs-frameless-cabinets": {
    ...
    alt: "modern frameless kitchen in a Treasure Valley home with warm white oak flat-panel cabinets, a crisp white perimeter, and wide full-extension drawers",
    topicTags: ["frameless", "framed", "kitchen", "cabinets"],
    source: "blog",
  },
  "what-are-rta-cabinets": {
    hero: blog("what-are-rta-cabinets"),
    alt: "budget-friendly Treasure Valley kitchen with warm natural white oak flat-panel cabinets, black bar pulls, and quartz counters",
    topicTags: ["rta", "kitchen", "cabinets"],
    source: "blog",
  },
  "custom-kitchen-cabinet-cost": {
    hero: blog("custom-kitchen-cabinet-cost"),
    alt: "luxury custom kitchen in a Treasure Valley home with navy blue and white two-tone cabinets, brass hardware, and a marble-look quartz island",
    topicTags: ["cost", "custom", "kitchen"],
    source: "blog",
  },
  "standard-kitchen-cabinet-sizes": {
    hero: blog("standard-kitchen-cabinet-sizes"),
    alt: "white Shaker kitchen in a Treasure Valley family home showing a full wall of base cabinets, upper cabinets, and a tall pantry",
    topicTags: ["sizes", "dimensions", "kitchen"],
    source: "blog",
  },
  "bathroom-vanity-buying-guide": {
    hero: blog("bathroom-vanity-buying-guide"),
    alt: "Treasure Valley bathroom with a modern floating white oak double vanity, white quartz top, undermount sinks, and a large framed mirror",
  ...
  "cabinet-refacing-vs-refinishing-vs-replacing": {
    ...
    alt: "Treasure Valley kitchen with warm white painted perimeter cabinets and a deep forest-green island, showing a refreshed cabinet update",
    topicTags: ["refacing", "refinishing", "kitchen"],
    source: "blog",
  },
  "kitchen-cabinet-organization-ideas": {
    hero: blog("kitchen-cabinet-organization-ideas"),
    alt: "Treasure Valley kitchen with base-cabinet drawers and pull-outs open showing organized interior storage in light white oak and white cabinets",
    topicTags: ["organization", "storage", "kitchen"],
    source: "blog",
  },
  "what-are-shaker-cabinets": {
    hero: blog("what-are-shaker-cabinets"),
    alt: "classic white Shaker kitchen in a Treasure Valley home with brushed-nickel hardware, subway tile, quartz counters, and a farmhouse sink",
    topicTags: ["shaker", "door styles", "kitchen"],
    source: "blog",
  },
  "how-to-paint-kitchen-cabinets": {
    hero: blog("how-to-paint-kitchen-cabinets"),
    alt: "freshly painted two-tone Treasure Valley kitchen with deep navy lower cabinets and warm white uppers, matte black hardware, and a smooth painted finish",
    topicTags: ["painting", "refinishing", "kitchen"],
    source: "blog",
  },
  "pantry-cabinet-ideas": {
    hero: blog("pantry-cabinet-ideas"),
    alt: "floor-to-ceiling walnut pantry cabinet in a Treasure Valley home with roll-out shelves and adjustable shelving stocked with everyday groceries",
    topicTags: ["pantry", "storage", "organization"],
    source: "blog",
  },
  "how-to-make-oak-cabinets-look-modern": {
    hero: blog("how-to-make-oak-cabinets-look-modern"),
    alt: "modern Treasure Valley kitchen with light natural white oak flat-panel cabinets, long matte-black bar pulls, and a white quartz waterfall counter",
    topicTags: ["oak", "modern", "kitchen"],
    source: "blog",
  },
  "best-wood-for-kitchen-cabinets": {
    hero: blog("best-wood-for-kitchen-cabinets"),
    alt: "warm traditional Treasure Valley kitchen with rich cherry and hickory stained solid-wood cabinets showing natural grain variation and oil-rubbed bronze hardware",
    topicTags: ["wood", "materials", "kitchen"],
    source: "blog",
  },
  "two-tone-kitchen-cabinets": {
    hero: blog("two-tone-kitchen-cabinets"),
    alt: "two-tone Treasure Valley kitchen with creamy off-white perimeter cabinets and a warm natural stained-wood island, brushed brass hardware, and pendant lights",
    topicTags: ["two-tone", "colors", "kitchen"],
    source: "blog",
  },
  "best-kitchen-cabinet-colors": {
    hero: blog("best-kitchen-cabinet-colors"),
    alt: "upscale Treasure Valley kitchen with deep navy-blue painted Shaker cabinets, brushed brass hardware, white marble-look quartz counters, and a large island",
    topicTags: ["colors", "navy", "kitchen"],
    source: "blog",
  },
  "sage-green-kitchen-cabinets": {
    hero: blog("sage-green-kitchen-cabinets"),
    alt: "Treasure Valley kitchen with soft muted sage green painted Shaker cabinets, aged brass hardware, white quartz counters, and a natural stone backsplash",
    topicTags: ["sage", "green", "kitchen"],
    source: "blog",
  },
  "home-office-built-ins": {
    hero: blog("home-office-built-ins"),
    alt: "custom home office built-in in a Treasure Valley home with a full wall of white oak and warm white cabinetry, a floating desk, and styled open shelving",
    topicTags: ["built-ins", "home office", "storage"],
    source: "blog",
  },
  "laundry-room-cabinet-ideas": {
    hero: blog("laundry-room-cabinet-ideas"),
    alt: "Treasure Valley laundry room with deep navy-blue Shaker cabinets, a folding counter over front-load machines, open uppers, a utility sink, and a hanging rod",
    topicTags: ["laundry", "built-ins", "storage"],
    source: "blog",
  },
  "how-to-plan-a-kitchen-cabinet-project": {
    hero: blog("how-to-plan-a-kitchen-cabinet-project"),
    alt: "transitional Treasure Valley kitchen blending warm white oak and crisp white cabinets with a large island, showing a functional work-triangle layout",
    topicTags: ["planning", "layout", "kitchen"],
    source: "blog",
  },
  "how-deep-are-kitchen-cabinets": {
    hero: blog("how-deep-are-kitchen-cabinets"),
    alt: "bright Treasure Valley kitchen with soft greige Shaker cabinets showing standard-depth base and upper cabinets along a wall with white quartz counters",
    topicTags: ["depth", "sizes", "kitchen"],
    source: "blog",
  },
  "mudroom-cabinets": {
    hero: blog("mudroom-cabinets"),
    alt: "custom mudroom built-in in a Treasure Valley home with white oak and sage-green lockers, open cubbies, coat hooks, and a bench with shoe storage",
    topicTags: ["mudroom", "built-ins", "storage"],
    source: "blog",
  },
  "how-to-clean-kitchen-cabinets": {
    hero: blog("how-to-clean-kitchen-cabinets"),
    alt: "warm traditional Treasure Valley kitchen with clean, well-kept honey-stained maple raised-panel cabinets, granite counters, and a tile backsplash",
  ...
  "cabinet-cost-per-linear-foot": {
    ...
    alt: "kitchen in a standard Treasure Valley family home with warm natural white oak cabinets, a crisp white perimeter, and black bar pulls",
  ...
  "stock-vs-custom-cabinets-boise": {
    ...
    alt: "custom Treasure Valley kitchen with floor-to-ceiling cream and off-white cabinets fitted precisely to a tall ceiling and around a window",
  ...
  "outdoor-bar-cabinet-storage": {
    ...
    alt: "covered outdoor kitchen with wood cabinets, drawers and beverage storage",
  ...
  "premium-outdoor-cabinetry": {
    ...
    alt: "outdoor kitchen with built-in grill and weather-exposed storage",
  ...
  "whole-home-cabinet-timeline": {
    ...
    alt: "open-plan home with coordinated kitchen cabinetry",
    topicTags: ["whole-home", "timeline", "kuna"],
    source: "city-service",
  },
  "living-through-cabinet-installation": {
    hero: "/images/blog/punch-list-guide.webp",
    alt: "kitchen during the final cabinet punch-list stage, with blue tape marking details",
  ...
  "cabinet-refresh-vs-replace-vs-moving": {
    ...
    alt: "kitchen with painted perimeter cabinets and a green island",
  ...
  "cabinet-planning-checklist": {
    ...
    alt: "open-plan home with kitchen storage beside the living area",
  ...
  "cabinet-company-red-flags": {
    ...
    alt: "dovetail drawer box and cabinet hardware for a quality inspection",
  ...
  "what-makes-great-cabinet-company": {
    ...
    alt: "kitchen showing coordinated cabinet doors, trim and island proportions",
  ...
  "custom-cabinet-shop-vs-big-box": {
    ...
    alt: "kitchen with fitted cabinetry and glass-front upper cabinets",
  ...
  "cabinet-construction-quality-guide": {
    ...
    alt: "cabinet construction detail: a natural maple dovetailed solid-wood drawer box on soft-close undermount glides",
  ...
  "cabinet-fabrication-installation": {
    hero: "/images/blog/punch-list-guide.webp",
    alt: "kitchen cabinetry at the final installation and adjustment stage",
  ...
  "cabinet-warranty-guide": {
    hero: "/images/blog/cabinet-construction-quality-guide.webp",
    alt: "cabinet drawer joinery and glide hardware relevant to warranty coverage",
  ...
  "cabinet-door-styles-guide": {
    ...
    alt: "transitional Treasure Valley kitchen with classic Shaker cabinet doors in warm greige and cream paint and a natural stained wood island",
  ...
  "built-in-storage-roi": {
    ...
    alt: "built-in media storage with coordinated shelving and cabinets",
    topicTags: ["roi", "built-ins", "star"],
    source: "city-service",
  },
  "outdoor-cabinet-roi": {
    hero: "/images/catalog/rooms/outdoor.webp",
    alt: "outdoor kitchen showing built-in cabinet storage around a grill and sink",
  ...
  "cabinet-finishes-colors-guide": {
    ...
    alt: "two-tone Treasure Valley kitchen with creamy white upper cabinets and a rich stained walnut lower run and island showing cabinet finishes and colors",
    topicTags: ["cabinets", "finishes", "guide"],
    source: "blog",
  },
  "cabinet-hardware-guide": {
    hero: blog("cabinet-hardware-guide"),
    alt: "luxury bathroom vanity in a Treasure Valley home with a walnut double vanity, statement matte-black and brass hardware, and a marble-look quartz top",
  ...
  "boise-cabinet-cost-guide": {
    ...
    alt: "two-tone kitchen with a cabinet island and full-height storage",
    topicTags: ["cost", "guide", "pillar"],
    source: "gallery",
  },
  "treasure-valley-cabinet-guide": {
    hero: area("boise"),
    alt: "oak kitchen cabinets for the Treasure Valley cabinet guide",
  ...
  "choose-cabinet-company-boise": {
    ...
    alt: "consultation with a Boise Cabinet Co designer reviewing door samples with homeowners",
