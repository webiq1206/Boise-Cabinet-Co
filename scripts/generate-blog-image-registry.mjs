...
const ENTRIES = {
  ...
  "framed-vs-frameless-cabinets": {
    ...
    alt: "Representative modern frameless kitchen in a Treasure Valley home with warm white oak flat-panel cabinets, a crisp white perimeter, and wide full-extension drawers",
    topicTags: ["frameless", "framed", "kitchen", "cabinets"],
    source: "blog",
  },
  "what-are-rta-cabinets": {
    hero: blog("what-are-rta-cabinets"),
    alt: "Representative budget-friendly Treasure Valley kitchen with warm natural white oak flat-panel cabinets, black bar pulls, and quartz counters",
    topicTags: ["rta", "kitchen", "cabinets"],
    source: "blog",
  },
  "custom-kitchen-cabinet-cost": {
    hero: blog("custom-kitchen-cabinet-cost"),
    alt: "Representative luxury custom kitchen in a Treasure Valley home with navy blue and white two-tone cabinets, brass hardware, and a marble-look quartz island",
    topicTags: ["cost", "custom", "kitchen"],
    source: "blog",
  },
  "standard-kitchen-cabinet-sizes": {
    hero: blog("standard-kitchen-cabinet-sizes"),
    alt: "Representative white Shaker kitchen in a Treasure Valley family home showing a full wall of base cabinets, upper cabinets, and a tall pantry",
    topicTags: ["sizes", "dimensions", "kitchen"],
    source: "blog",
  },
  "bathroom-vanity-buying-guide": {
    hero: blog("bathroom-vanity-buying-guide"),
    alt: "Representative Treasure Valley bathroom with a modern floating white oak double vanity, white quartz top, undermount sinks, and a large framed mirror",
  ...
  "cabinet-refacing-vs-refinishing-vs-replacing": {
    ...
    alt: "Representative Treasure Valley kitchen with warm white painted perimeter cabinets and a deep forest-green island, showing a refreshed cabinet update",
    topicTags: ["refacing", "refinishing", "kitchen"],
    source: "blog",
  },
  "kitchen-cabinet-organization-ideas": {
    hero: blog("kitchen-cabinet-organization-ideas"),
    alt: "Representative Treasure Valley kitchen with base-cabinet drawers and pull-outs open showing organized interior storage in light white oak and white cabinets",
    topicTags: ["organization", "storage", "kitchen"],
    source: "blog",
  },
  "what-are-shaker-cabinets": {
    hero: blog("what-are-shaker-cabinets"),
    alt: "Representative classic white Shaker kitchen in a Treasure Valley home with brushed-nickel hardware, subway tile, quartz counters, and a farmhouse sink",
    topicTags: ["shaker", "door styles", "kitchen"],
    source: "blog",
  },
  "how-to-paint-kitchen-cabinets": {
    hero: blog("how-to-paint-kitchen-cabinets"),
    alt: "Representative freshly painted two-tone Treasure Valley kitchen with deep navy lower cabinets and warm white uppers, matte black hardware, and a smooth painted finish",
    topicTags: ["painting", "refinishing", "kitchen"],
    source: "blog",
  },
  "pantry-cabinet-ideas": {
    hero: blog("pantry-cabinet-ideas"),
    alt: "Representative floor-to-ceiling walnut pantry cabinet in a Treasure Valley home with roll-out shelves and adjustable shelving stocked with everyday groceries",
    topicTags: ["pantry", "storage", "organization"],
    source: "blog",
  },
  "how-to-make-oak-cabinets-look-modern": {
    hero: blog("how-to-make-oak-cabinets-look-modern"),
    alt: "Representative modern Treasure Valley kitchen with light natural white oak flat-panel cabinets, long matte-black bar pulls, and a white quartz waterfall counter",
    topicTags: ["oak", "modern", "kitchen"],
    source: "blog",
  },
  "best-wood-for-kitchen-cabinets": {
    hero: blog("best-wood-for-kitchen-cabinets"),
    alt: "Representative warm traditional Treasure Valley kitchen with rich cherry and hickory stained solid-wood cabinets showing natural grain variation and oil-rubbed bronze hardware",
    topicTags: ["wood", "materials", "kitchen"],
    source: "blog",
  },
  "two-tone-kitchen-cabinets": {
    hero: blog("two-tone-kitchen-cabinets"),
    alt: "Representative two-tone Treasure Valley kitchen with creamy off-white perimeter cabinets and a warm natural stained-wood island, brushed brass hardware, and pendant lights",
    topicTags: ["two-tone", "colors", "kitchen"],
    source: "blog",
  },
  "best-kitchen-cabinet-colors": {
    hero: blog("best-kitchen-cabinet-colors"),
    alt: "Representative upscale Treasure Valley kitchen with deep navy-blue painted Shaker cabinets, brushed brass hardware, white marble-look quartz counters, and a large island",
    topicTags: ["colors", "navy", "kitchen"],
    source: "blog",
  },
  "sage-green-kitchen-cabinets": {
    hero: blog("sage-green-kitchen-cabinets"),
    alt: "Representative Treasure Valley kitchen with soft muted sage green painted Shaker cabinets, aged brass hardware, white quartz counters, and a natural stone backsplash",
    topicTags: ["sage", "green", "kitchen"],
    source: "blog",
  },
  "home-office-built-ins": {
    hero: blog("home-office-built-ins"),
    alt: "Representative custom home office built-in in a Treasure Valley home with a full wall of white oak and warm white cabinetry, a floating desk, and styled open shelving",
    topicTags: ["built-ins", "home office", "storage"],
    source: "blog",
  },
  "laundry-room-cabinet-ideas": {
    hero: blog("laundry-room-cabinet-ideas"),
    alt: "Representative Treasure Valley laundry room with deep navy-blue Shaker cabinets, a folding counter over front-load machines, open uppers, a utility sink, and a hanging rod",
    topicTags: ["laundry", "built-ins", "storage"],
    source: "blog",
  },
  "how-to-plan-a-kitchen-cabinet-project": {
    hero: blog("how-to-plan-a-kitchen-cabinet-project"),
    alt: "Representative transitional Treasure Valley kitchen blending warm white oak and crisp white cabinets with a large island, showing a functional work-triangle layout",
    topicTags: ["planning", "layout", "kitchen"],
    source: "blog",
  },
  "how-deep-are-kitchen-cabinets": {
    hero: blog("how-deep-are-kitchen-cabinets"),
    alt: "Representative bright Treasure Valley kitchen with soft greige Shaker cabinets showing standard-depth base and upper cabinets along a wall with white quartz counters",
    topicTags: ["depth", "sizes", "kitchen"],
    source: "blog",
  },
  "mudroom-cabinets": {
    hero: blog("mudroom-cabinets"),
    alt: "Representative custom mudroom built-in in a Treasure Valley home with white oak and sage-green lockers, open cubbies, coat hooks, and a bench with shoe storage",
    topicTags: ["mudroom", "built-ins", "storage"],
    source: "blog",
  },
  "how-to-clean-kitchen-cabinets": {
    hero: blog("how-to-clean-kitchen-cabinets"),
    alt: "Representative warm traditional Treasure Valley kitchen with clean, well-kept honey-stained maple raised-panel cabinets, granite counters, and a tile backsplash",
  ...
  "cabinet-cost-per-linear-foot": {
    ...
    alt: "Representative kitchen in a standard Treasure Valley family home with warm natural white oak cabinets, a crisp white perimeter, and black bar pulls",
  ...
  "stock-vs-custom-cabinets-boise": {
    ...
    alt: "Representative custom Treasure Valley kitchen with floor-to-ceiling cream and off-white cabinets fitted precisely to a tall ceiling and around a window",
  ...
  "cabinet-door-styles-guide": {
    ...
    alt: "Representative transitional Treasure Valley kitchen with classic Shaker cabinet doors in warm greige and cream paint and a natural stained wood island",
  ...
  "cabinet-finishes-colors-guide": {
    ...
    alt: "Representative two-tone Treasure Valley kitchen with creamy white upper cabinets and a rich stained walnut lower run and island showing cabinet finishes and colors",
    topicTags: ["cabinets", "finishes", "guide"],
    source: "blog",
  },
  "cabinet-hardware-guide": {
    hero: blog("cabinet-hardware-guide"),
    alt: "Representative luxury bathroom vanity in a Treasure Valley home with a walnut double vanity, statement matte-black and brass hardware, and a marble-look quartz top",
