...
const siteHeroes = [
  ...
  { id: "process-design", path: "/images/marketing/process-design-review.webp", pages: ["/", "/about"], alt: "Cabinet finish samples and layout plans during Boise Cabinet Co design consultation" },
