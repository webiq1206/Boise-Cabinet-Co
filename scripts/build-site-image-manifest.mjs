...
const siteHeroes = [
  ...
  { id: "process-about", path: "/images/marketing/process-about.webp", pages: ["/about"], alt: "Boise Cabinet Co cabinetmaker assembling a frameless cabinet box in the Kuna Idaho shop" },
  ...
  { id: "hero-construction", path: "/images/marketing/hero-construction.webp", pages: ["/construction"], alt: "CNC cabinet door machining at the Boise Cabinet Co Kuna Idaho shop" },
