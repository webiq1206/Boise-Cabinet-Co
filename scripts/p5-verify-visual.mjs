...
const routes=parent?['/','/quote','/sitemap','/legal/terms','/legal/privacy','/legal/quickbooks-disconnect']:['/','/cabinets','/catalog','/accessories','/construction','/compare','/estimate','/about','/contact','/testimonials'];
const results=[];
let failed=false;
