...
function quotasFor(from: PageNode): Quota {
  switch (from.type) {
    case "blog":
      return { service: 2, blog: 1 };
    case "service":
      return { "city-service": 2, service: 2, blog: 1 };
    case "city":
      return { "city-service": 3, service: 2 };
    case "city-service":
      return { service: 1, city: 1, "city-service": 2, blog: 1 };
    default:
      return {};
  }
}
