...
export function CityCrosslinks({ currentCity, serviceSlug, serviceName }: CityCrosslinksProps) {
  ...
  return (
    <section className="py-12 md:py-16 bg-muted/30" data-testid="section-city-crosslinks">
        ...
        <div className="max-w-6xl mx-auto space-y-6 md:space-y-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
            {otherCities.map((city: CityData) => (
              <Card key={city.slug} className="hover-elevate" data-testid={`card-city-${city.slug}`}>
