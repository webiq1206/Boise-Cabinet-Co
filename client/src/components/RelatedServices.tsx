...
export function RelatedServices({ currentServiceSlug, city, limit = 4 }: RelatedServicesProps) {
  ...
  return (
    <section className="py-12 md:py-16 bg-muted" data-testid="section-related-services">
        ...
        <div className="max-w-6xl mx-auto space-y-6 md:space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {relatedServices.map((service) => {
              ...
              return (
                <Card key={service.slug} className="hover-elevate" data-testid={`card-related-${service.slug}`}>
                  ...
                  <CardContent>
                    <Button variant="outline" size="sm" className="w-full" asChild data-testid={`button-related-${service.slug}`}>
                      <Link href={href}>
                        Learn More
