    ...
    <div className="flex flex-col">
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            src={heroBackground} 
            alt="Professional landscaping services with beautiful green lawn and garden in Idaho"
        ...
        <div className="container px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            <h1 className="text-4xl md:text-5xl font-bold text-white">Professional Landscaping Services</h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/services/patio-installation">
                <Card className="hover-elevate transition-all duration-200 cursor-pointer h-full">
                  <CardHeader>
      ...
      <section id="quote" className="py-16 md:py-24 bg-muted/30">
        <div className="container px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <QuoteForm preselectedService="landscaping" />
          </div>
        </div>
      </section>
    </div>
