...
export const BLOG_IMAGE_REGISTRY: Record<string, BlogImageEntry> = {
  ...
  'accessible-bathroom-vanity-guide': {
    ...
    alt: 'Accessible bathroom vanity height and storage in a Nampa bath',
...
export const HUB_HERO_IMAGES: Record<string, string> = {
  ...
  'whole-home-cabinetry': '/images/catalog/collections/semi-custom.webp',
  'choosing-cabinet-company': '/images/marketing/hero-about.webp',
  'cabinet-project-process': '/images/marketing/process-design-review.webp',
  'cabinet-roi': '/images/gallery/gallery-kitchen-after.webp',
