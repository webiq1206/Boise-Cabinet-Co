...
| Schema: BreadcrumbList | Home > Services | FIXED (added) |
| Internal links | links to every service category + every individual service | PASS |
| Image alt | none needed (icon-based grid) | PASS |
